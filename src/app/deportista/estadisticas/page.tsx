  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            <h2 className="text-xl font-bold text-gray-900">Rendimiento en Partidos</h2>
            <p className="text-sm text-gray-600 mt-1">Historial acumulado desde las planillas registradas por el entrenador</p>
          </CardHeader>
          <CardContent className="space-y-5">
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              ...
              <div className="rounded-lg bg-slate-50 p-3">
                <p className="text-xs font-semibold uppercase text-gray-500">Puntos</p>
                <p className="mt-1 text-2xl font-bold text-gray-900">{partidos?.puntos || 0}</p>
              </div>
              <div className="rounded-lg bg-slate-50 p-3">
